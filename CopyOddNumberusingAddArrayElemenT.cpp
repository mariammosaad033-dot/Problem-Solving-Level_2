...
void CopyOddNumberusingAddArrayElemenT(int SourceArr[100], int DestinationArr[100], int arrLength, int& arr2Length)
{
    for (int i = 0;i < arrLength;i++)
    {
        if (SourceArr[i] % 2 == 1)
...
int main()
{
    ...
    CopyOddNumberusingAddArrayElemenT(arr1, arr2, arrLength, arr2Length);
